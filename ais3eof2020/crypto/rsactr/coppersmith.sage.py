...
_sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_4 = Integer(4); _sage_const_1024 = Integer(1024); _sage_const_200 = Integer(200); _sage_const_3 = Integer(3); _sage_const_7 = Integer(7); _sage_const_0p5 = RealNumber('0.5'); _sage_const_4040 = Integer(4040); _sage_const_2020 = Integer(2020); _sage_const_0p01 = RealNumber('0.01'); _sage_const_20000 = Integer(20000); _sage_const_16 = Integer(16)
from pwn import *
...
#      N = p*q
    ...
    # Problem to equation (default)
    P = PolynomialRing(ZmodN, names=('x',)); (x,) = P._first_ngens(1)#, implementation='NTL')
    pol = (x - _sage_const_4040  * nonce) ** _sage_const_3  - _sage_const_2020 
    dd = pol.degree()

    beta = _sage_const_1                              # we should have q >= N^beta
    epsilon = _sage_const_0p01                      # <= beta/7
    mm = ceil(beta**_sage_const_2  / (dd * epsilon))    # optimized
    tt = floor(dd * mm * ((_sage_const_1 /beta) - _sage_const_1 ))   # optimized
    XX = ceil(N**((beta**_sage_const_2 /dd) - epsilon)) # we should have |diff| < X
...
def main():
    ...
    r = remote('eductf.zoolab.org', _sage_const_20000 )
    ...
    nonce = pow(bytes_to_long(cipher[:_sage_const_16 ]), _sage_const_3 , n)
    print(f'nonce={nonce}')
