...
struct Candidate{
    char *name;
    uint8_t votes; // Note; 7-byte padding
...
void handler( int signum ){
    uint8_t max; // Note: uninitialized
    ...
    while(1){
        ...
        switch( n ){
            ...
            case 2:
                ...
                read( 0 , msg , candidates[idx].votes ); // Note: overflow, msg(224)+padding(8), votes <= 255
                puts( "Done!" );
                break;
    ...
    while(1){
        ...
        switch( n ){
            case 1:
                ...
                //       leak canary and old_rbp by brute-forcing token
